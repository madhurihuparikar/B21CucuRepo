...
public class TestCompareJson {
	...
	public void user_compare_two_json_string(){
		...
		//Here  in LENIENT there is no restriction for parameters/contents and its sequence
...
//		//Case3: Extra field in expected : FAIL
		//Here  in STRICT there is no restriction in its sequence BUT there is restriction for parameters/contents
...
//		JSONAssert.assertEquals(expected4, actual4, JSONCompareMode.STRICT);
		...
		//Here  in NON_EXTENSIBLE there is restriction in its sequence AND there is restriction for parameters/contents
